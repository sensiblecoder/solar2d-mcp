...
TOOL = Tool(
    ...
    description=(
        ...
        "IMPORTANT: Never leave a card in 'in_progress' without resolution. "
        "If you cannot complete the work, you MUST move it to 'blocked_work' "
        "with a blocked_reason explaining what's needed. "
